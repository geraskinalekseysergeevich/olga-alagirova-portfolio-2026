	...
	return (
		...
		>
			<CaseTextBlock
				...
				title="Задача"
				paragraph="Клиент обратился с запросом на обновление бренда. Нужно было: осовременить визуальный язык; создать метафору, напрямую связанную с ключевой компетенцией сервиса; отстроиться от других суббрендов, сохранив ДНК айдентики Сбера (3D-графика и фирменный градиент)."
			/>
			<CaseTextBlock
				title="Решение"
				paragraph="В качестве метафоры мы использовали образ тепловой карты (heatmap) — инструмента, который буквально показывает концентрацию внимания. Фирменный градиент Сбера визуально близок к стандартному градиенту тепловых карт. Мы превратили это сходство в концептуальное преимущество. На базе heatmap мы создали 3D-объект и построили визуальную систему вокруг этой формы, сохранив 3D-характер айдентики Сбера, но придав ей собственный пластический язык.​​​​​​​"
			/>
			<CaseMediaSet imagesSrc={['/cases/sber-seller/1.jpg', '/cases/sber-seller/2.jpg']} />
			<CaseTextBlock
			...
			/>
			<CaseMediaSet imagesSrc={['/cases/sber-seller/6.jpg', '/cases/sber-seller/7.jpg', '/cases/sber-seller/8.jpg']} />
			<CaseMediaSet
			...
			/>
			<CaseMediaSet imagesSrc={['/cases/sber-seller/11.jpg']} />
			<CaseTextBlock
