...
export const TWELVE_STOREEZ_ROUTE = '12storeez'
...
export const EGGLESTON_ROUTE = 'eggleston'
export const SOFIA_SONECHKA_ROUTE = 'sofia-sonechka'
export const YANDEX_RENT_ROUTE = 'yandex-rent'
