...
export const GkbDavydovskyPage = () => {
	return (
		...
		>
			...
			/>
			<CaseMediaSet imagesSrc={['/cases/gkb-davydovsky/10.jpg', '/cases/gkb-davydovsky/video/website.mp4']} />
			<CaseFooter
