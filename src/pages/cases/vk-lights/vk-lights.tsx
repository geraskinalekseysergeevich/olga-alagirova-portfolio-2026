...
export const VkLightsPage = () => {
	return (
		...
		>
			...
			/>
			<CaseMediaSet imagesSrc={['/cases/vk-lights/1.jpg']} />
			<CaseTextBlock
			...
			/>
			<CaseMediaSet imagesSrc={['/cases/vk-lights/2.jpg']} />
			<CaseTextBlock
			...
			/>
			<CaseMediaSet imagesSrc={['/cases/vk-lights/3.jpg']} />
			<CaseTextBlock
			...
			/>
			<CaseMediaSet imagesSrc={['/cases/vk-lights/4.jpg']} />
			<CaseTextBlock
			...
			/>
			<CaseMediaSet imagesSrc={['/cases/vk-lights/5.jpg']} />
			<CaseTextBlock
